-- ============================================================================
-- ADD ONLY: Learn Templates Data
-- ============================================================================
-- This script adds ONLY the new template data to existing database
-- Run this on a database that already has tables created
-- ============================================================================

-- Learn templates - My Cycle (11 templates, 2 placeholders each)
INSERT INTO public.learn_templates (category, template_text, placeholder_key, sort_order, is_active) 
VALUES
...
-- Learn templates - Fitness (8 templates, 1 placeholder each)
INSERT INTO public.learn_templates (category, template_text, placeholder_key, sort_order, is_active) 
VALUES
...
-- Learn templates - Diet (8 templates, 1 placeholder each)
INSERT INTO public.learn_templates (category, template_text, placeholder_key, sort_order, is_active) 
VALUES
...
-- Learn templates - Fasting (8 templates, 1 placeholder each)
INSERT INTO public.learn_templates (category, template_text, placeholder_key, sort_order, is_active) 
VALUES
...
-- ============================================================================
-- SELECT category, COUNT(*) as template_count FROM public.learn_templates GROUP BY category;
